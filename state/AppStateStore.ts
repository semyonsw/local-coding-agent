...
export type AgentParameterThinkingMode = "adaptive" | "enabled" | "disabled";

export type AgentParameterSettings = {
  temperatureOverride?: number;
  maxOutputTokensOverride?: number;
  thinkingMode?: AgentParameterThinkingMode;
...
export type AppState = DeepImmutable<{
  ...
  // Left-side agent parameter drawer visibility.
  agentParametersBarVisible?: boolean;
  // User-adjustable request defaults from the left-side agent parameter drawer.
  agentParameters?: AgentParameterSettings;
...
export function getDefaultAppState(): AppState {
  ...
  return {
    ...
    agentParametersBarVisible: false,
    agentParameters: {},
    kairosEnabled: false,
